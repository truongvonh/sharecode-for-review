...
const NewFeedItem = ({ newFeedItem, user = null, ...voteFunc }) => {
  ...
  // console.log(
  //   "NAVIGATE_URL.USER_PROFILE_PAGE(getNestedObjectSafe(newFeedItem, ['user', '_id']))",
  //   NAVIGATE_URL.USER_PROFILE_PAGE(getNestedObjectSafe(newFeedItem, ['user', '_id']))
  // );
      ...
      <div className="new-feed-item bg-white rounded-lg p-3 mb-4 fz-16">
          ...
          <div className="user-infor d-flex mb-3 align-items-center">
            ...
            <div className="relate-info pl-3 fz-16">
              ...
              <div className="align-items-center">
                ...
                <Link>
                  <a>
                    <p className="font-weight-bold fz-14 color-link mb-0 cursor-pointer">
        ...
        <footer className="border-top pt-3">
          {!user ? (
            ...
            <CommentAction user={user} id={newFeedItem.last_id || 0} />
          )}
        </footer>
      </div>
    </>
