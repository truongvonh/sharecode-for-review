...
const CardUser = ({ userData, flowIdSuccess }) => {
  ...
  return (
    <>
      ...
      />
      <div className="col-md-6 col-lg-4 col-xl-3 px-2 mb-3">
              ...
              <Link href="#">
                <a className="d-block mb-1">
                  <Truncate lines={1} className="university-name fz-14">
                    {userData.profile && userData.profile.school && userData.profile.school.name}
                  </Truncate>
                </a>
              </Link>
              {userData.follow != null && (
                <Button
                  disabled={userData.follow === null}
