...
const mapStateToProps = store => {
  return {
    ...
    preLayout: store.common.preLayout,
    collapseMenu: store.common.collapseMenu,
    layoutType: store.common.layoutType,
    navBackColor: store.common.navBackColor,
    navBackImage: store.common.navBackImage,
    navIconColor: store.common.navIconColor,
    navBrandColor: store.common.navBrandColor,
    layout6Background: store.common.layout6Background,
    layout6BackSize: store.common.layout6BackSize,
    rtlLayout: store.common.rtlLayout,
    navFixedLayout: store.common.navFixedLayout,
    boxLayout: store.common.boxLayout,
    navDropdownIcon: store.common.navDropdownIcon,
    navListIcon: store.common.navListIcon,
    navActiveListColor: store.common.navActiveListColor,
    navListTitleColor: store.common.navListTitleColor,
    navListTitleHide: store.common.navListTitleHide
  };
};
